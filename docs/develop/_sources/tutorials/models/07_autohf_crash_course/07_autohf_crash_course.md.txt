...
In this tutorial, we will exclusively use safiretools to build Hamiltonians,
...
We can easily convert safiretools Hamiltonians to the AutoHF format using,
...
where `hamiltonian_safire` is a Hamiltonian generated by safiretools, and
...
# "hamiltonian" contains the safiretools format Hamiltonian
